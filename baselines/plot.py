...
results1 = pu.load_results('logs/Acrobot/lr1e-4_bch32_bf1e4_TT', 1, 0, 0) 
results2 = pu.load_results('logs/Acrobot/lr5e-4_bch32_bf1e4_TT', 1, 0, 0)
results3 = pu.load_results('logs/Acrobot/lr1e-3_bch32_bf1e4_TT', 1, 0, 0)
results4 = pu.load_results('logs/Acrobot/lr5e-3_bch32_bf1e4_TT', 1, 0, 0)
r1 = results1[0]
r2 = results2[0]
r3 = results3[0]
r4 = results4[0]
...
plt.subplot(121, title='Batch size-32, Model-TT', xlabel='Timesteps', ylabel='Average reward')
...
plt.savefig('pics/Acrobot_bch32_bf1e4_TT.png',  format='png')

#plots for sweeping learning rate with batchsize-256, buffersize-1e4, model-TT
results5 = pu.load_results('logs/Acrobot/lr1e-4_bch256_bf1e4_TT', 1, 0, 0)
results6 = pu.load_results('logs/Acrobot/lr5e-4_bch256_bf1e4_TT', 1, 0, 0)
results7 = pu.load_results('logs/Acrobot/lr1e-3_bch256_bf1e4_TT', 1, 0, 0)
results8 = pu.load_results('logs/Acrobot/lr5e-3_bch256_bf1e4_TT', 1, 0, 0)
r5 = results5[0]
r6 = results6[0]
r7 = results7[0]
r8 = results8[0]
plt.switch_backend("agg")
plt.figure(figsize=(16,4))
plt.subplot(121, title='Batch size-256, prioritized experience replay-True, Dueling-True', xlabel='Timesteps', ylabel='Average reward')
...
plt.bar(x, time)
plt.xticks(x, ('0.0001', '0.0005', '0.001', '0.005'))
plt.savefig('pics/Acrobot_bch256_bf1e4_TT.png',  format='png')

#plots for sweeping learning rate with batchsize-32, buffersize-1e4, model-FF
results1 = pu.load_results('logs/Acrobot/lr1e-4_bch32_bf1e4_FF', 1, 0, 0) 
results2 = pu.load_results('logs/Acrobot/lr5e-4_bch32_bf1e4_FF', 1, 0, 0)
results3 = pu.load_results('logs/Acrobot/lr1e-3_bch32_bf1e4_FF', 1, 0, 0)
results4 = pu.load_results('logs/Acrobot/lr5e-3_bch32_bf1e4_FF', 1, 0, 0)
r1 = results1[0]
r2 = results2[0]
r3 = results3[0]
r4 = results4[0]
plt.switch_backend("agg")
plt.figure(figsize=(16, 4))
plt.subplot(121, title='Batch size-32, prioritized experience replay-False, Dueling-False', xlabel='Timesteps', ylabel='Average reward')
plt.plot(r1.progress.steps, r1.progress["mean 100 episode reward"], label='lr-0.0001')
plt.plot(r2.progress.steps, r2.progress["mean 100 episode reward"], label='lr-0.0005')
plt.plot(r3.progress.steps, r3.progress["mean 100 episode reward"], label='lr-0.001')
plt.plot(r4.progress.steps, r4.progress["mean 100 episode reward"], label='lr-0.005')
...
plt.bar(x, time)
plt.xticks(x, ('0.0001', '0.0005', '0.001', '0.005'))
plt.savefig('pics/Acrobot_bch32_bf1e4_FF.png',  format='png')

#plots for sweeping learning rate with batchsize-256, buffersize-1e4, model-FF
results5 = pu.load_results('logs/Acrobot/lr1e-4_bch256_bf1e4_FF', 1, 0, 0)
results6 = pu.load_results('logs/Acrobot/lr5e-4_bch256_bf1e4_FF', 1, 0, 0)
results7 = pu.load_results('logs/Acrobot/lr1e-3_bch256_bf1e4_FF', 1, 0, 0)
results8 = pu.load_results('logs/Acrobot/lr5e-3_bch256_bf1e4_FF', 1, 0, 0)
r5 = results5[0]
r6 = results6[0]
r7 = results7[0]
r8 = results8[0]
plt.switch_backend("agg")
plt.figure(figsize=(16,4))
plt.subplot(121, title='Batch size-256, Model-FF', xlabel='Timesteps', ylabel='Average reward')
plt.plot(r5.progress.steps, r5.progress["mean 100 episode reward"], label='lr-0.0001')
plt.plot(r6.progress.steps, r6.progress["mean 100 episode reward"], label='lr-0.0005')
plt.plot(r7.progress.steps, r7.progress["mean 100 episode reward"], label='lr-0.001')
plt.plot(r8.progress.steps, r8.progress["mean 100 episode reward"], label='lr-0.005')
...
plt.bar(x, time)
plt.xticks(x, ('0.0001', '0.0005', '0.001', '0.005'))
plt.savefig('pics/Acrobot_bch256_bf1e4_FF.png',  format='png')
...
plt.subplot(121, title='Batch size-256, Model-TT', xlabel='Timesteps', ylabel='Average reward')
