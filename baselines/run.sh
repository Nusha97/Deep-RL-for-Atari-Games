...
time python -m baselines.run --alg=deepq --env=Acrobot-v1 --log_path=logs/Acrobot/lr1e-4_bch32_bf1e4_TT --save_path=models/Acrobot_lr1e-4_bch32_bf1e4_TT.pkl --num_timesteps=1e5
